    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (opcion == 1) {//repite el programa hasta que el usario quiere salir y entra 2
                ...
                // usando printf para limitar la salida en 2 decimales,he hecho -0.005 para limitarlo sin redondear al valor cercano porque sale 3.34
